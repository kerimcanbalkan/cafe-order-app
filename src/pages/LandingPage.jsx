  ...
  return (
    <main className="min-h-screen bg-white text-nord-0 flex flex-col justify-center items-center px-4 text-center">
      ...
      <p className="max-w-xl text-lg mb-6">
         A modern, multi-role restaurant management system built with React, TailwindCSS featuring admin, waiter, cashier, and client interfaces. This app allows seamless ordering, employee management, and performance tracking through a clean and interactive dashboard.
      </p>
